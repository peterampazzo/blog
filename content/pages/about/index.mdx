...
I'm a Senior Data Engineer at [Nykredit](https://www.nykredit.com/en-gb/) in Wealth & Asset Management. 
I focus on Wealth data modernization, building resilient integrations with various systems, enabling users to consume data effectively, and adopting a cloud-first approach. 
I'm also part of the Nykredit Data CoE.
...
land-use data from OpenStreetMap. In February 2022 for my Master's thesis, I joined DSB Digital Lab
(part of the Danish State Railway) to study the users' usage data of [Kørmit](https://www.dsb.dk/dsb-erhverv/delemobilitet/). This is a
...
Moving to a different country changes your habits, and since Denmark is flat, I've had to adapt.
I've traded mountain hiking in the Dolomites for road cycling and ~rowing~ running. 
From time to time, a good bouldering or padel session is also a great alternative when the weather isn’t ideal.

I also enjoy photography and have published some of my work on [Unsplash](https://unsplash.com/@peterampazzo).

You can find me on [BlueSky](https://bsky.app/profile/peterampazzo.com) /
